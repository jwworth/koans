...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # Answer: The shovel operator is more versatile. It works for other object
    # types such as arrays. It also looks like an arrow, which some might find
    # more intention-revealing and readable than '+='.
  end
