...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # ANSWER:
    #
    # 'send' is a loaded word that can mean different things in different
    # contexts. If 'send' is implemented in other places, we can still use
    # '__send__' and expect the same behavior.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # ANSWER:
    #
    # The exception would not be raised, and whatever was defined
    # inside the method_missing method would be executed. This is a fundamental
    # technique used in Ruby metaprogramming.
    #
    # NOTE:
    #
